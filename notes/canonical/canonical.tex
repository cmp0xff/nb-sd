...
\frac{\Lambda}{3} Na^3} + \pp^2 a^3 \rbr{\frac{1}{N^2}{v^\phi}^2 - m^2\phi^2}.
\end{equation}
Canonical momenta
\begin{equation}
...
\begin{align}
H^\text{t} &= H^\text{c} + v^N p_N, \\
H^\text{c} &= -\frac{\nG}{3\pp} \frac{N}{a} p_a^2 + \frac{1}{4\pp^2} 
\frac{N}{a^3} p_\phi^2 + \frac{3\pp}{4\nG}\rbr{\frac{\Lambda}{3}a^2 - 1}Na
+ \pp^2 m^2 a^3 \phi^2.
\end{align}
